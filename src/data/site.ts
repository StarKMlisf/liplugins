...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    summary: '原版骑乘自动迈步与朝向、可配置命名规则，以及任意多行宠物名牌。',
    description:
      'LiPet 0.28.0 为养成扩展第一批：原版坐骑支持自动迈步和两种朝向，ModelEngine 保留独立驾驶；命名规则支持去色长度、白名单与禁用词；名牌支持 1–8 行自定义模板和热重载。保留捕捉、成长、双商城、背包、等级模型与死亡扣级。品质、性格、闪光、材料进化及探索派遣尚未上线。',
