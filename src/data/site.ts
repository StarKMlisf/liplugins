...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    summary: '覆盖每宠独立 MythicMobs 等级技能、中文多文件宠物类型配置、管理二级面板原路返回、仓库四键、宠物获取、成长、双排行榜、PlayerPoints 商城、骑乘、捕捉、背包与跨服数据的一体化宠物系统。',
    description:
      'LiPet 是面向群组服的 Bukkit 宠物框架，包含每种宠物独立配置且按等级解锁的 MythicMobs 技能、七种触发器、概率/冷却与 power 等级成长、管理页属性/成长面板原路返回、“我的宠物”列表入口、仓库四键操作、可中文命名且支持多 YML 与子目录的宠物类型配置、SQLite/MySQL 热切换、召唤上限专用中文提示、双排行榜、PlayerPoints/Vault 商城、属性成长、捕捉仪式、完全自定义 GUI、离线及全服宠物管理、骑乘、战斗导航、外部模型、CraftEngine 完整物品挂钩和扩展 API。',
