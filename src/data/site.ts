...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    summary: '支持宠物币/金币/点券名称配置与热重载，提供 MEG 等级模型、原版捕捉随机属性、捕捉球商店和中文宠物养成配置。',
    description:
      'LiPet 是面向群组服的 Bukkit 宠物框架，采用 pet-types.yml 公共默认值与宠物目录单宠差异配置；默认捕捉规则允许的全部原版生物会生成中文独立 YML，MCPets 单宠文件可直接放入中文子目录并通过 MythicMobs 生成自定义实体。0.27.6 支持宠物币、Vault 金币和 PlayerPoints 点券名称分别配置，成功重载后重新打开两个商城即可生效，失败保留旧名且不改变商品价格或扣款。插件同时提供旧原版类型 ID 兼容、每宠 MythicMobs 等级技能、管理页原路返回、“我的宠物”列表、仓库四键、SQLite/MySQL 热切换、双排行榜、PlayerPoints/Vault 商城、属性成长、MEG 等级模型、原版捕捉随机属性、真实捕捉球商店、捕捉仪式、完全自定义 GUI、离线及全服宠物管理、骑乘、战斗导航、外部模型、CraftEngine 完整物品挂钩与可启停的 CE 捕捉球/食物案例，以及扩展 API。',
    version: '0.27.6-SNAPSHOT',
    status: '持续维护',
    platform: 'Paper / Folia',
    minecraft: '1.21.11 · 26.1.2 · 26.2',
    java: 'Java 21+',
