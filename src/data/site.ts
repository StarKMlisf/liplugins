...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    description:
      'LiPet 0.29.2 修复隔墙停步、追击与跟随冲突，增加卡住目标恢复；保留附近敌对怪物主动索敌，默认 8 格，支持单宠开关，坐下、骑乘及返回时不抢占控制；捕捉宠物支持品质、性格和闪光：权重、概率、成长与属性倍率可配置，已捕捉特性独立存档，旧宠物保持原数值。仓库、详情、名牌与 PAPI 展示特性，保留自动迈步、朝向、命名规则、双商城、背包、等级模型与死亡扣级。材料进化及探索派遣为后续批次。',
