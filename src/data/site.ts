...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    summary: '保留原物品属性完成 3D 换皮，并提供可蹲下右键选装的常驻 NPC 试衣间。',
    description:
      'LiSkin 以 CraftEngine 物品作为皮肤来源，为原物品提供收集、购买、应用和管理外观的完整流程。1.9.5 新增 A/B 点原生玩家人偶试衣间：常驻 NPC 打开全部服装菜单，玩家可在购买前观看套用自身皮肤并自动旋转的实际模型。',
    version: '1.9.5',
    status: '持续维护',
    platform: 'Paper / Folia',
