...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    summary: '覆盖宠物获取、成长、宠物币管理、稳定骑乘名牌、末影龙飞行骑乘、CraftEngine 完整物品挂钩、捕捉、背包与跨服数据的一体化宠物系统。',
    description:
      'LiPet 是面向群组服的 Bukkit 宠物框架，包含 SQLite/MySQL 热切换、属性成长、捕捉仪式、宠物币奖励、完全自定义 GUI、离线及全服宠物管理、可热切换商城、跟随坐下、骑乘、战斗导航、外部模型、CraftEngine 完整物品挂钩和扩展 API。',
    version: '0.26.17-SNAPSHOT',
    status: '持续维护',
    platform: 'Paper / Folia',
    minecraft: '1.21.11 · 26.1.2 · 26.2',
    java: 'Java 21+',
    availability: '付费',
    priceCny: 68,
    dependencies: ['Vault（可选）', 'PlaceholderAPI（可选）', 'ModelEngine / CraftEngine（按配置可选）', 'MySQL / Redis（跨服功能按需）'],
    features: [
      '宠物创建、召唤与持久化',
      '中文属性成长、喂养与升级',
      '捕捉仪式、商城与宠物币奖励',
