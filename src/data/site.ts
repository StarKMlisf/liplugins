...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    summary: '覆盖“我的宠物”列表入口、宠物获取、成长、召唤上限明确反馈、双排行榜、可读货币名称、飞行宠物名牌安全回传、PlayerPoints 商城、骑乘、捕捉、背包与跨服数据的一体化宠物系统。',
    description:
      'LiPet 是面向群组服的 Bukkit 宠物框架，包含主菜单“我的宠物”与宠物列表入口、SQLite/MySQL 热切换、单宠召唤上限专用中文提示及旧语言迁移、宠物币与宠物等级排行榜、可配置商城货币显示名、飞行宠物 TextDisplay 名牌安全回传、PlayerPoints/Vault 商城、属性成长、捕捉仪式、完全自定义 GUI、离线及全服宠物管理、骑乘、战斗导航、外部模型、CraftEngine 完整物品挂钩和扩展 API。',
    version: '0.26.23-SNAPSHOT',
    status: '持续维护',
    platform: 'Paper / Folia',
    minecraft: '1.21.11 · 26.1.2 · 26.2',
    java: 'Java 21+',
