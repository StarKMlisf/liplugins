...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    name: 'LiSkin',
    catalogLabel: '换皮',
    kicker: 'CraftEngine 换皮与常驻试衣间',
    summary: '保留原物品属性完成 3D 换皮；蹲下右键 NPC 选装，观看时再次蹲下右键即可连续换装。',
    description:
      'LiSkin 以 CraftEngine 物品作为皮肤来源，为原物品提供收集、购买、应用和管理外观的完整流程。1.9.6 的 A/B 点原生玩家人偶试衣间支持常驻 NPC、全部服装菜单和无指令连续换装，玩家可在购买前观看套用自身皮肤并自动旋转的实际模型。',
    version: '1.9.6',
    status: '持续维护',
    platform: 'Paper / Folia',
