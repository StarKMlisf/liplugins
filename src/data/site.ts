...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    summary: '覆盖“我的宠物”入口、仓库四键操作、中文多文件宠物类型配置、宠物获取、成长、双排行榜、PlayerPoints 商城、骑乘、捕捉、背包与跨服数据的一体化宠物系统。',
    description:
      'LiPet 是面向群组服的 Bukkit 宠物框架，包含“我的宠物”列表入口、左键召唤/右键管理/潜行左键收回/潜行右键放生的仓库四键操作、可中文命名且支持多 YML 与子目录的宠物类型配置、SQLite/MySQL 热切换、召唤上限专用中文提示、双排行榜、PlayerPoints/Vault 商城、属性成长、捕捉仪式、完全自定义 GUI、离线及全服宠物管理、骑乘、战斗导航、外部模型、CraftEngine 完整物品挂钩和扩展 API。',
    version: '0.26.24-SNAPSHOT',
    status: '持续维护',
    platform: 'Paper / Folia',
    minecraft: '1.21.11 · 26.1.2 · 26.2',
    java: 'Java 21+',
