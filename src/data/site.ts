...
export const works: WorkEntry[] = [
  ...
  },
  {
    ...
    catalogLabel: '副本',
    kicker: '多世界地牢副本系统',
    summary: '面向 RPG 服的中文地牢编辑器、触发器引擎与运行诊断，支持 Paper/Folia 多世界副本流程。',
    description:
      'LiDungeon 提供中文化地牢副本玩法体系，支持副本编辑、波次与怪物配置、触发器链、权限指令和跨世界实例管理。重点面向 26.1.2 与 26.2 的稳定运行、Folia 安全调度与故障可回溯。',
    version: '2.0.1-zhcn-folia.8',
    status: '持续维护',
    platform: 'Paper / Folia',
    minecraft: 'Paper 26.1.2 · 26.2',
    java: 'Java 25',
    availability: '免费',
    dependencies: ['Vault（可选）', 'PlaceholderAPI（可选）'],
    features: [
      '中文完整 Wiki、指令与配置文档',
      '地牢创建、编辑、保存与版本迁移',
      '触发器、条件与动作链配置',
