...
const liPetDocs = defineDocs('lipet', [
  ...
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.28.0 骑乘、命名及名牌配置，以及完整捕捉与成长教程。', group: '文档总览', order: 1 },
  ...
  { file: 'docs/更新日志.md', slug: 'changelog', title: '更新日志总览', summary: '0.28.0 骑乘、命名与多行名牌，以及历史更新。', group: '文档总览', order: 23 },
  ...
  { file: 'docs/安装与更新.md', slug: 'install', title: '安装与更新', summary: '0.28.0 更新、naming.yml 生成与旧名牌兼容说明。', group: '管理员文档', order: 20 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.28.0-SNAPSHOT', summary: '地面跟随停靠、返回路径连续性、模型座位跨区保护和名牌刷新优化。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
