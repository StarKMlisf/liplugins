...
const liPetDocs = defineDocs('lipet', [
  ...
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.27.8 召唤无响应修复、等待与异常反馈，以及骑乘名牌、实时转向和完整中文配置教程。', group: '文档总览', order: 1 },
  ...
  { file: 'docs/更新日志.md', slug: 'changelog', title: '更新日志总览', summary: '0.27.8 召唤无响应修复、骑乘名牌与视角转向、货币名称热重载及历史更新记录。', group: '文档总览', order: 23 },
  ...
  { file: 'docs/捕捉与商城.md', slug: 'capture-shop', title: '捕捉、宠物商城与道具商城', summary: '捕捉仪式、宠物币获取、每日奖励、三种商城货币名称与重载生效方式。', group: '玩家文档', order: 12 },
  { file: 'docs/跟随骑乘与战斗.md', slug: 'behavior-combat', title: '跟随、骑乘与战斗', summary: '骑乘名牌全员隐藏、原地与持续前进转向、原生寻路、召回、安全回传和协战。', group: '玩家文档', order: 13 },
  { file: 'docs/背包与宠物道具.md', slug: 'items-inventory', title: '背包、信号棒与技能书', summary: '54 格宠物背包、聊天改名、信号棒、技能书和保存规则。', group: '玩家文档', order: 14 },
  { file: 'docs/安装与更新.md', slug: 'install', title: '安装与更新', summary: '0.27.8 换 Jar 后重启、配置保护、运行环境与历史升级流程。', group: '管理员文档', order: 20 },
  { file: 'docs/命令与权限.md', slug: 'commands-permissions', title: '命令与权限', summary: '仅使用 /lipet 的玩家、商城、捕捉、奖励和管理员权限。', group: '管理员文档', order: 21 },
  { file: 'docs/配置说明.md', slug: 'configuration', title: '配置说明', summary: '召唤等待和异常提示、骑乘名牌隐藏、货币名称热重载、公共默认值与中文单宠 YML。', group: '管理员文档', order: 22 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.27.8-SNAPSHOT', summary: '召唤无响应修复、等待与异常反馈、骑乘名牌和实时转向，以及中文宠物养成配置。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
