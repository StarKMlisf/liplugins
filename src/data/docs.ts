...
const liseasonsDocs = defineDocs('liseasons', [
  { file: '更新日志.md', slug: 'changelog', title: '更新日志', summary: '1.0.79 大型移动龙卷风、分叉雷暴、火流星、蘑菇云原生粒子与创造模式安全预览。', group: '文档总览', order: 2 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'liseasons', name: 'LISeasons', version: '1.0.79', summary: '四季、节气、十三种持续灾害、大型原生粒子、安全预览与 Folia 兼容文档。', icon: 'grass', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liseasonsDocs },
