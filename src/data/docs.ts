...
const liseasonsDocs = defineDocs('liseasons', [
  { file: '更新日志.md', slug: 'changelog', title: '更新日志', summary: '1.0.78 龙卷风改为移动原生云雾，支持缓弯、贴地与共享粒子预算；包含十三种持续灾害。', group: '文档总览', order: 2 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'liseasons', name: 'LISeasons', version: '1.0.78', summary: '四季、节气、十三种持续灾害、移动云雾龙卷风、十五种可选模型与 Folia 兼容文档。', icon: 'grass', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liseasonsDocs },
