...
const liPetDocs = defineDocs('lipet', [
  ...
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.29.0 品质性格闪光、骑乘及名牌配置，以及完整捕捉与成长教程。', group: '文档总览', order: 1 },
  ...
  { file: 'docs/更新日志.md', slug: 'changelog', title: '更新日志总览', summary: '0.29.0 品质、性格与闪光，以及历史更新。', group: '文档总览', order: 23 },
  ...
  { file: 'docs/安装与更新.md', slug: 'install', title: '安装与更新', summary: '0.29.0 更新、traits.yml 生成、数据库升级及旧宠物兼容说明。', group: '管理员文档', order: 20 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.29.0-SNAPSHOT', summary: '品质、性格与闪光捕捉，持久化成长快照、骑乘和可配置名牌。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
