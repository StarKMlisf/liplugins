...
const liPetDocs = defineDocs('lipet', [
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.27.3 全量生成默认可捕捉原版宠物中文 YML，并支持公共默认值、单宠差异及 MCPets 文件。', group: '文档总览', order: 1 },
  { file: 'docs/PET_FEATURE_MATRIX.md', slug: 'feature-matrix', title: '功能矩阵', summary: '逐项核对宠物能力的实现范围、入口和当前状态。', group: '文档总览', order: 2 },
  { file: 'docs/更新日志-2026-08-29-全量宠物配置与MCPets兼容.md', slug: 'changelog-2026-08-29-full-pet-config-mcpets', title: '2026-08-29 全量宠物配置与 MCPets 兼容', summary: '全量原版宠物中文独立 YML、公共默认值与单宠差异、中文目录迁移及 MCPets 直接读取。', group: '文档总览', order: 3 },
  { file: 'docs/更新日志-2026-08-29-老宠物类型兼容.md', slug: 'changelog-2026-08-29-old-type-compat', title: '2026-08-29 老宠物类型兼容与独立 YML', summary: '旧原版类型 ID 自动兼容、legacy-ids 自定义别名和商城 10 种宠物独立配置。', group: '文档总览', order: 4 },
  { file: 'docs/更新日志-2026-08-29-MythicMobs技能优化.md', slug: 'changelog-2026-08-29-mythicmobs-skill-optimization', title: '2026-08-29 MythicMobs 技能优化', summary: '冷却热路径、失败退避、逐技能日志限频、API 变体兼容及状态规则统计。', group: '文档总览', order: 5 },
  { file: 'docs/更新日志-2026-08-29-MythicMobs等级技能.md', slug: 'changelog-2026-08-29-mythicmobs-level-skills', title: '2026-08-29 MythicMobs 等级技能', summary: '每宠独立 MM 技能、等级解锁、七种触发器、概率、冷却及 power 成长。', group: '文档总览', order: 6 },
  { file: 'docs/更新日志-2026-08-29-管理菜单返回.md', slug: 'changelog-2026-08-29-management-return', title: '2026-08-29 管理菜单返回修复', summary: '属性与成长面板保留打开来源，返回同一只宠物的管理页，并安全补全可配置按钮。', group: '文档总览', order: 7 },
  { file: 'docs/更新日志-2026-08-29-仓库介绍样式.md', slug: 'changelog-2026-08-29-warehouse-lore-style', title: '2026-08-29 仓库介绍样式', summary: '潜行操作统一绿色，永久删除警告独立为红色段落，并迁移官方历史默认 Lore。', group: '文档总览', order: 8 },
  { file: 'docs/更新日志-2026-08-29-仓库四键与宠物类型目录.md', slug: 'changelog-2026-08-29-warehouse-controls-pet-type-files', title: '2026-08-29 仓库四键与宠物类型目录', summary: '潜行左键真正收回宠物，潜行右键放生，并支持中文目录与多个宠物类型 YML。', group: '文档总览', order: 9 },
  { file: 'docs/更新日志-2026-08-29-我的宠物入口.md', slug: 'changelog-2026-08-29-my-pets-entry', title: '2026-08-29 “我的宠物”入口调整', summary: '主菜单按钮改为“我的宠物”，点击说明改为“打开宠物列表”，并保护服主自定义文案。', group: '文档总览', order: 10 },
  { file: 'docs/更新日志-2026-08-29-召唤上限提示.md', slug: 'changelog-2026-08-29-active-pet-limit-message', title: '2026-08-29 召唤上限提示修复', summary: '已有活动宠物时使用明确的最大召唤数量提示，并迁移官方历史默认语言。', group: '文档总览', order: 11 },
  { file: 'docs/更新日志-2026-08-29-鹦鹉名牌跟随.md', slug: 'changelog-2026-08-29-parrot-nameplate-follow', title: '2026-08-29 鹦鹉名牌跟随修复', summary: '飞行宠物安全回传前清理 TextDisplay，并在传送完成或失败后立即恢复名牌。', group: '文档总览', order: 12 },
  { file: 'docs/更新日志-2026-08-29-商城货币显示.md', slug: 'changelog-2026-08-29-shop-currency-display', title: '2026-08-29 商城货币显示修复', summary: 'INTERNAL 配置 ID 改为显示可配置的“宠物币”，两个商城统一解析货币名称。', group: '文档总览', order: 13 },
  { file: 'docs/更新日志-2026-08-29-权限排行榜与PlayerPoints.md', slug: 'changelog-2026-08-29-permissions-leaderboards-playerpoints', title: '2026-08-29 权限组、排行榜与 PlayerPoints 更新', summary: '普通玩家权限自动 true、宠物币/等级排行榜和 PlayerPoints 商城结算。', group: '文档总览', order: 14 },
  { file: 'docs/更新日志-2026-08-29-仓库快捷操作.md', slug: 'changelog-2026-08-29-warehouse-shortcuts', title: '2026-08-29 仓库快捷操作更新', summary: '左键与蹲下左键召回、右键管理、蹲下右键放生确认、语言分流和宠物币快捷指令。', group: '文档总览', order: 15 },
  { file: 'docs/更新日志-2026-08-29-宠物币与末影龙.md', slug: 'changelog-2026-08-29-coin-dragon', title: '2026-08-29 宠物币、名牌与末影龙更新', summary: '管理员宠物币 give/take/look、名牌掉位修复、末影龙 HOVER 稳定与飞行骑乘。', group: '文档总览', order: 16 },
  { file: 'docs/更新日志-2026-08-28-骑乘交互.md', slug: 'changelog-2026-08-28-riding', title: '2026-08-28 骑乘与交互更新', summary: '凋零/末影龙骑乘显示、末影龙部件交互、在线 Tab、召唤语言和永久删除指令。', group: '文档总览', order: 17 },
  { file: 'docs/更新日志-2026-08-28-CE.md', slug: 'craftengine-integration', title: 'CraftEngine 完整物品挂钩', summary: 'CE 物品生成、识别、索引、热重载，以及喂食、捕捉球、技能书、商城、信号棒和 GUI 全入口配置。', group: '文档总览', order: 18 },
  { file: 'docs/更新日志-2026-08-28-UI.md', slug: 'changelog-2026-08-28-ui', title: '2026-08-28 UI 更新', summary: '全部菜单点击音效、功能按钮多槽位复制和旧配置安全迁移。', group: '文档总览', order: 19 },
  { file: 'docs/更新日志-2026-08-28.md', slug: 'changelog-2026-08-28', title: '2026-08-28 管理与召唤更新', summary: 'give/take、离线与全服批处理、Tab 补全及领地保护内安全召唤。', group: '文档总览', order: 20 },
  { file: 'docs/更新日志-2026-08-27.md', slug: 'changelog-2026-08-27', title: '2026-08-27 更新', summary: '指定玩家单宠管理、商城总开关、热重载、升级步骤和兼容验证。', group: '文档总览', order: 21 },
  { file: 'docs/更新日志.md', slug: 'changelog', title: '2026-08-26 更新日志', summary: 'MEG 模型重叠修复、CraftEngine 物品喂食、取消 /lp 别名及升级检查。', group: '文档总览', order: 22 },
  ...
  { file: 'docs/测试与故障排查.md', slug: 'testing-troubleshooting', title: '测试与故障排查', summary: '160 项测试、87 种原版配置生成、中文目录迁移、MCPets 原文件加载、持久化、线程和依赖检查。', group: '管理员文档', order: 24 },
...
export const docSets: DocSet[] = [
  { slug: 'liemc', name: 'LIEMC', version: '0.1.0+build.106', summary: 'EMC 经济、物品回收、解锁兑换、收藏检索、自定义 GUI、全局商品 Lore、CraftEngine 与跨服同步文档。', icon: 'gold', groups: ['文档总览', '玩家文档', '管理员文档'], docs: liemcDocs },
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.27.3-SNAPSHOT', summary: '全量原版宠物中文独立 YML、公共默认值与单宠差异、MCPets 文件兼容、MythicMobs 自定义实体与等级技能、PlayerPoints、完全自定义 UI 与数据库文档。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
