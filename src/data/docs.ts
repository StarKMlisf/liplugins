...
const liseasonsDocs = defineDocs('liseasons', [
  { file: '更新日志.md', slug: 'changelog', title: '更新日志', summary: '1.0.76 新增 MythicMobs + ModelEngine 九种灾害及流星模型，补齐粒子数据与生命周期清理。', group: '文档总览', order: 2 },
  { file: '自然灾害与龙卷风.md', slug: 'natural-disasters', title: '自然灾害与龙卷风', summary: '八种持续灾害、立体龙卷风、冰雹、沙尘暴、冻雨、避险与中文配置。', group: '管理员文档', order: 28 },
  ...
  { file: '玩家-季节事件.md', slug: 'player-events', title: '季节事件与流星雨', summary: '了解 20 种默认事件、八种灾害避险、高空流星和陨星奖励。', group: '玩家文档', order: 13 },
...
const liPetDocs = defineDocs('lipet', [
  ...
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.27.9 道具商城、飞行速度、骑乘疾跑和回收可靠性修复，以及完整中文配置教程。', group: '文档总览', order: 1 },
  ...
  { file: 'docs/更新日志.md', slug: 'changelog', title: '更新日志总览', summary: '0.27.9 商城、飞行加速与回收可靠性修复，以及历史更新记录。', group: '文档总览', order: 23 },
  { file: 'docs/玩家入门.md', slug: 'player', title: '玩家入门', summary: '创建、召唤、收回、改名、骑乘宠物并使用完整 /lipet 指令。', group: '玩家文档', order: 10 },
  { file: 'docs/成长与喂养.md', slug: 'growth-feeding', title: '成长、属性与喂养', summary: '中文属性、衍生战斗数值、原版及 CraftEngine 食物、技能书和按等级解锁的 MM 技能。', group: '玩家文档', order: 11 },
  { file: 'docs/捕捉与商城.md', slug: 'capture-shop', title: '捕捉、宠物商城与道具商城', summary: '道具余额独立提示与安全退款、捕捉仪式、宠物币获取、奖励和三种商城货币。', group: '玩家文档', order: 12 },
  { file: 'docs/跟随骑乘与战斗.md', slug: 'behavior-combat', title: '跟随、骑乘与战斗', summary: '飞行属性、骑乘疾跑与实时转向、名牌隐藏、原生寻路、安全回传和协战。', group: '玩家文档', order: 13 },
  { file: 'docs/背包与宠物道具.md', slug: 'items-inventory', title: '背包、信号棒与技能书', summary: '54 格宠物背包、信号棒回收反馈、聊天改名、技能书和保存规则。', group: '玩家文档', order: 14 },
  { file: 'docs/安装与更新.md', slug: 'install', title: '安装与更新', summary: '0.27.9 换 Jar 后重启、配置保护、运行环境与历史升级流程。', group: '管理员文档', order: 20 },
  { file: 'docs/命令与权限.md', slug: 'commands-permissions', title: '命令与权限', summary: '仅使用 /lipet 的玩家、商城、捕捉、奖励和管理员权限。', group: '管理员文档', order: 21 },
  { file: 'docs/配置说明.md', slug: 'configuration', title: '配置说明', summary: '道具与回收消息、骑乘疾跑倍率、召唤反馈、货币名称、公共默认值与中文单宠 YML。', group: '管理员文档', order: 22 },
  { file: 'docs/存储与跨服.md', slug: 'storage-network', title: '存储与跨服', summary: 'SQLite/MySQL 热切换、Redis、租约、切服和异常恢复。', group: '管理员文档', order: 23 },
  { file: 'docs/测试与故障排查.md', slug: 'testing-troubleshooting', title: '测试与故障排查', summary: '召唤无响应的退休任务与队列排查、验证边界，以及历史骑乘、重载和支付记录。', group: '管理员文档', order: 24 },
  { file: 'docs/常见问题.md', slug: 'faq', title: '常见问题', summary: '排查召唤无响应与重载无效、等待提示、骑乘名牌、视角转向、宠物数据和商城名称。', group: '管理员文档', order: 25 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'liseasons', name: 'LISeasons', version: '1.0.76', summary: '四季、节气、八种持续灾害、MM + ME 九种模型、中暑冻伤和 Folia 兼容文档。', icon: 'grass', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liseasonsDocs },
