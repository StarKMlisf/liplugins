...
const liPetDocs = defineDocs('lipet', [
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.26.14 安装、全服管理、可配置 UI、数据库热切换、成长、CraftEngine 完整物品挂钩、模型与排错。', group: '文档总览', order: 1 },
  { file: 'docs/PET_FEATURE_MATRIX.md', slug: 'feature-matrix', title: '功能矩阵', summary: '逐项核对宠物能力的实现范围、入口和当前状态。', group: '文档总览', order: 2 },
  { file: 'docs/更新日志-2026-08-28-CE.md', slug: 'craftengine-integration', title: 'CraftEngine 完整物品挂钩', summary: 'CE 物品生成、识别、索引、热重载，以及喂食、捕捉球、技能书、商城、信号棒和 GUI 全入口配置。', group: '文档总览', order: 3 },
  { file: 'docs/更新日志-2026-08-28-UI.md', slug: 'changelog-2026-08-28-ui', title: '2026-08-28 UI 更新', summary: '全部菜单点击音效、功能按钮多槽位复制和旧配置安全迁移。', group: '文档总览', order: 4 },
  { file: 'docs/更新日志-2026-08-28.md', slug: 'changelog-2026-08-28', title: '2026-08-28 管理与召唤更新', summary: 'give/take、离线与全服批处理、Tab 补全及领地保护内安全召唤。', group: '文档总览', order: 5 },
  { file: 'docs/更新日志-2026-08-27.md', slug: 'changelog-2026-08-27', title: '2026-08-27 更新', summary: '指定玩家单宠管理、商城总开关、热重载、升级步骤和兼容验证。', group: '文档总览', order: 6 },
  { file: 'docs/更新日志.md', slug: 'changelog', title: '2026-08-26 更新日志', summary: 'MEG 模型重叠修复、CraftEngine 物品喂食、取消 /lp 别名及升级检查。', group: '文档总览', order: 7 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.26.14-SNAPSHOT', summary: '宠物养成、全服管理、完全自定义 UI、数据库热切换、CraftEngine 完整物品挂钩与扩展设计文档。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
