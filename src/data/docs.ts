...
const liPetDocs = defineDocs('lipet', [
  ...
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.27.7 骑乘名牌全员隐藏与实时视角转向、货币名称热重载、等级模型及完整中文配置教程。', group: '文档总览', order: 1 },
  ...
  { file: 'docs/更新日志.md', slug: 'changelog', title: '更新日志总览', summary: '0.27.7 骑乘名牌与视角转向、货币名称热重载、等级模型与随机捕捉，以及历史更新记录。', group: '文档总览', order: 23 },
  ...
  { file: 'docs/配置说明.md', slug: 'configuration', title: '配置说明', summary: '骑乘名牌隐藏开关、货币名称热重载、公共默认值、中文单宠 YML、MCPets 文件与等级技能。', group: '管理员文档', order: 22 },
  { file: 'docs/存储与跨服.md', slug: 'storage-network', title: '存储与跨服', summary: 'SQLite/MySQL 热切换、Redis、租约、切服和异常恢复。', group: '管理员文档', order: 23 },
  { file: 'docs/测试与故障排查.md', slug: 'testing-troubleshooting', title: '测试与故障排查', summary: '两种 API 构建各 264 项测试，骑乘名牌、视角与任务清理检查，以及历史重载、支付和兼容记录。', group: '管理员文档', order: 24 },
  { file: 'docs/常见问题.md', slug: 'faq', title: '常见问题', summary: '排查骑乘名牌残留、视角不转向、宠物丢失、收回残留、背包及商城货币名称。', group: '管理员文档', order: 25 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.27.7-SNAPSHOT', summary: '骑乘名牌全员隐藏与实时视角转向、货币名称热重载、MEG 等级模型、随机捕捉和中文宠物配置。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
