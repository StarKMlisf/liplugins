...
const liPetDocs = defineDocs('lipet', [
  ...
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.27.6 三种货币名称配置与热重载、MEG 等级模型、随机捕捉属性及完整中文配置教程。', group: '文档总览', order: 1 },
  ...
  { file: 'docs/更新日志.md', slug: 'changelog', title: '更新日志总览', summary: '0.27.6 货币名称热重载、0.27.5 等级模型与随机捕捉，以及保留的历史更新记录。', group: '文档总览', order: 23 },
  ...
  { file: 'docs/配置说明.md', slug: 'configuration', title: '配置说明', summary: '货币名称配置与热重载、公共默认值、中文单宠 YML、MCPets 文件、模型、食物和等级技能。', group: '管理员文档', order: 22 },
  { file: 'docs/存储与跨服.md', slug: 'storage-network', title: '存储与跨服', summary: 'SQLite/MySQL 热切换、Redis、租约、切服和异常恢复。', group: '管理员文档', order: 23 },
  { file: 'docs/测试与故障排查.md', slug: 'testing-troubleshooting', title: '测试与故障排查', summary: '216 项测试、服务端双商城名称与重载探针、PlayerPoints 实际扣款，以及历史兼容与故障排查。', group: '管理员文档', order: 24 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.27.6-SNAPSHOT', summary: '宠物币、金币、点券名称配置与热重载，MEG 等级模型、原版捕捉随机属性、捕捉球商店及中文宠物配置文档。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
