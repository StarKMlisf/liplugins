...
const liPetDocs = defineDocs('lipet', [
  ...
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.29.2 追击绕障及主动索敌、品质、骑乘、名牌、捕捉与成长教程。', group: '文档总览', order: 1 },
  ...
  { file: 'docs/更新日志.md', slug: 'changelog', title: '更新日志总览', summary: '0.29.2 追击绕障与历史更新。', group: '文档总览', order: 23 },
  ...
  { file: 'docs/安装与更新.md', slug: 'install', title: '安装与更新', summary: '0.29.2 更新、启动版本确认、主动索敌配置及旧宠物兼容说明。', group: '管理员文档', order: 20 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.29.2-SNAPSHOT', summary: '主动索敌与跟随优先，品质性格闪光、骑乘和可配置名牌。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
