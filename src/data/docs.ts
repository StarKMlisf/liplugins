...
const liseasonsDocs = defineDocs('liseasons', [
  { file: '更新日志.md', slug: 'changelog', title: '更新日志', summary: '1.0.72 持续自然灾害、中暑冻伤与体感温度优化。', group: '文档总览', order: 2 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'liseasons', name: 'LISeasons', version: '1.0.72', summary: '四季、节气、持续自然灾害、中暑冻伤、Folia 流星雨与 Residence 冰雪兼容文档。', icon: 'grass', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liseasonsDocs },
