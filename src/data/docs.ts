...
const liPetDocs = defineDocs('lipet', [
  ...
  { file: 'docs/WIKI.md', slug: 'home', title: 'LiPet 完整 Wiki', summary: '0.29.6 属性界面行数修复、监守者主人保护、WG 旗标与召唤跟随及追击绕障、主动索敌、品质、骑乘、捕捉与成长教程。', group: '文档总览', order: 1 },
...
export const docSets: DocSet[] = [
  ...
  { slug: 'lipet', name: 'LiPet', version: '0.29.6-SNAPSHOT', summary: '属性界面 1-6 行布局、监守者主人保护、WG 区域开关、重召恢复跟随、主人保护与主动索敌，品质性格闪光、骑乘和可配置名牌。', icon: 'leaf', groups: ['文档总览', '玩家文档', '管理员文档', '开发者文档'], docs: liPetDocs },
