...
- `pet-types.yml` 保存全局名牌、骑乘、背包和目录设置；`宠物类型/` 默认按多个 YML 保存实体、模型、属性、食物、成长和行为，目录名及子目录均可使用中文。
...
输出：`target/LiPet-0.26.25-SNAPSHOT.jar`
