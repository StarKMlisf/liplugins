...
> 本页从 LiPet `0.26.16-SNAPSHOT` 完整 Wiki 同步整理；需要连续查阅全部功能时，请返回 [LiPet 完整 Wiki](../home/)。
...
`0.26.16-SNAPSHOT` 共 103 项自动测试通过；同一 Java 21 成品 Jar 已在 Paper 26.2 Build 111 + Java 25 完成真实启动、SQLite 依赖加载、`/lipet status` 与安全关闭。当前自动环境没有在线客户端，凋零/末影龙骑乘画面、Boss 血条和潜行右键仍需在目标服务器最终确认。成品 SHA-256 为 `DF898CEC5C09A1AB0102127E84293ADE28DB24139E60E5AD18D180F06F4014A7`。
