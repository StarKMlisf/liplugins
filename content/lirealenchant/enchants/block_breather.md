...
|---:|---:|---|---|---|---|---|
| 1 | 15% | 完全取消本次窒息伤害 | 单次受伤 | 无 | 无 | 无 |
| 2 | 30% | 完全取消本次窒息伤害 | 单次受伤 | 无 | 无 | 无 |
| 3 | 45% | 完全取消本次窒息伤害 | 单次受伤 | 无 | 无 | 无 |

## 配置位置

`plugins/LiRealEnchant2/enchants/block_breather.yml`
