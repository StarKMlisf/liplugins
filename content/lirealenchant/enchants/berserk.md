...
| 项目 | 内容 |
|---|---|
| 注册键 | `yunmengze:berserk` |
| 类型 | 普通 |
| 稀有度 | 稀有 |
| 最高等级 | 3 |
| 适用装备 | 武器 |
| 实际触发 | 自身生命低于 45% 或刚受伤时近战命中 |
| 自然获取 | 附魔台、战利品、村民交易 |
| 默认启用 | 是 |
| 冲突附魔 | 无 |
...
|---:|---:|---|---|---|---|---|
| 1 | 100% | 伤害 +6% | 单次命中 | 无 | 无 | 无 |
| 2 | 100% | 伤害 +12% | 单次命中 | 无 | 无 | 无 |
| 3 | 100% | 伤害 +18% | 单次命中 | 无 | 无 | 无 |

## 配置位置

`plugins/LiRealEnchant2/enchants/berserk.yml`
