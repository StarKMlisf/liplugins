...
|---:|---:|---|---|---|---|---|
| 1 | 100% | 恢复 20 点水下氧气时间 | 瞬时 | 无 | 无 | 无 |
| 2 | 100% | 恢复 40 点水下氧气时间 | 瞬时 | 无 | 无 | 无 |
| 3 | 100% | 恢复 60 点水下氧气时间 | 瞬时 | 无 | 无 | 无 |

## 配置位置

`plugins/LiRealEnchant2/enchants/rebreather.yml`
