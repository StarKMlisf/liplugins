...
击杀精英或 Boss 后获得短暂战斗增益。

| 项目 | 内容 |
|---|---|
| 注册键 | `yunmengze:exalted` |
| 类型 | 普通 |
| 稀有度 | 史诗 |
| 最高等级 | 3 |
| 适用装备 | 武器 |
| 实际触发 | 击杀 Boss 或带 boss 标签生物 |
| 自然获取 | 附魔台、战利品、村民交易 |
| 默认启用 | 是 |
| 冲突附魔 | 无 |
...
|---:|---:|---|---|---|---|---|
| 1 | 100% | 获得力量 1 与速度 I | 8 秒 | 无 | 无 | 无 |
| 2 | 100% | 获得力量 2 与速度 I | 10 秒 | 无 | 无 | 无 |
| 3 | 100% | 获得力量 3 与速度 I | 12 秒 | 无 | 无 | 无 |

## 配置位置

`plugins/LiRealEnchant2/enchants/exalted.yml`
